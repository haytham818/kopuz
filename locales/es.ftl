...
# Additional Keys
no_genres_found = No hay géneros encontrados en tu librería.
jump_back_in = Volver atrás
by_artist = Por
by_artist_full = Por { $artist }
start_listening = Empezar a escuchar
listen_now = Escuchar ahora
no_albums_found = No hay álbumes encontrados en tu librería.
...
no_tracks_in_library = No hay pistas encontradas en tu librería.
...
gruvbox_dark_soft = Gruvbox Oscuro Suave
dracula = Dracula
nord = Nord
catppuccin_mocha = Catppuccin Mocha
ef_night = Ef Noche
ayu_dark = Ayu Oscuro
ayu_mirage = Ayu Espejismo
vague = Vago
...
rosepine = Rosé Pine
default_light = Claro Predeterminado
catppuccin_latte = Catppuccin Latte
rosepine_dawn = Rosé Pine Amanecer
everforest_light = Everforest Claro
ayu_light = Ayu Claro
one_light = Uno Claro
gruvbox_light_soft = Gruvbox Claro Suave
